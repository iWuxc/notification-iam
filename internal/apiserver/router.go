...
import (
	...
	"github.com/marmotedu/iam/internal/apiserver/controller/v1/notification"
...
func installController(g *gin.Engine) *gin.Engine {
	...
	v1 := g.Group("/v1")
	{
		...
		notificationv1 := v1.Group("/msgpush", middleware.Publish())
		{
			notificationController := notification.NewMsgPushController(storeIns)
			notificationv1.POST("", notificationController.Post)
		}
	}
